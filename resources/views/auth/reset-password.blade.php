...
<head>
    ...
    <title>Atur Ulang Sandi | Maxilla Dental Care</title>
    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-24 relative">
            ...
            <div class="w-full max-w-md mt-10 lg:mt-0">
                ...
                <div>
                    <h2 class="font-heading text-3xl font-bold text-secondary mb-2">Atur Ulang Sandi</h2>
                    <p class="text-slate-500 mb-8">Silakan buat kata sandi baru untuk akun Anda.</p>
                </div>
                ...
                <form action="{{ route('password.update') }}" method="POST" class="space-y-5">
                    ...
                    <!-- Konfirmasi Password -->
                    <div>
                        <label for="password_confirmation" class="block text-sm font-medium text-slate-700 mb-2">Konfirmasi Sandi Baru</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-slate-400" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
